...
import {
  ...
  Image,     // For Gallery/Images
  CalendarDays,
  Clock,
  BookText,   // For PDF/Document resources
  FileText    // For notes/text resources
} from 'lucide-react';

// Main App Component
// Now receives advocatePosts, resources, and blogPosts as props from index.js
const App = ({ advocatePosts, resources, blogPosts }) => {
  ...
  const advocate = {
    ...
    contact: {
      ...
      address: "123, Legal Chambers, MG Road, Lucknow, Uttar Pradesh, India - 226001",
      mapLink: "https://www.google.com/maps/search/Lucknow+Uttar+Pradesh+India" // Corrected example map link
    },
    social: {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceID = 'YOUR_SERVICE_ID'; // e.g., 'service_abcdefg'
    const templateID = 'YOUR_TEMPLATE_ID'; // e.g., 'template_12345'
    const publicKey = 'YOUR_PUBLIC_KEY'; // e.g., 'user_xyzABC123'
      ...
      <header className="bg-gray-800 shadow-lg py-4 px-6 md:px-12 sticky top-0 z-50">
        <nav className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#gallery" className="text-gray-300 hover:text-teal-400 font-medium transition duration-300">Gallery</a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-800 mt-4 rounded-lg shadow-lg py-4">
            ...
            <a href="#gallery" onClick={() => setIsMobileMenuOpen(false)} className="block px-6 py-2 text-gray-300 hover:bg-gray-700 transition duration-200">Gallery</a>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <img
                src="%PUBLIC_URL%/images/advocate-profile.jpg" // Local image from public folder
            ...
            {blogPosts.map((post) => ( // Use blogPosts from props
              <div key={post._id} className="bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-700">
                ...
                <div className="p-6">
                  ...
                  <a href="#" className="text-teal-400 hover:underline font-medium flex items-center">
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="space-y-4 text-lg">
                <div className="flex items-center">
                  ...
                  <a href={`tel:${advocate.contact.phone}`} className="hover:underline text-gray-300">{advocate.contact.phone}</a>
                </div>
                <div className="flex items-center">
                  <Mail className="w-6 h-6 mr-3 text-teal-400" />
                  <a href={`mailto:${advocate.contact.email}`} className="hover:underline text-gray-300">{advocate.contact.email}</a>
                </div>
                <div className="flex items-start">
                  <MapPin className="w-6 h-6 mr-3 mt-1 text-teal-400 flex-shrink-0" />
                  <a href={advocate.contact.mapLink} target="_blank" rel="noopener noreferrer" className="hover:underline text-gray-300">
                    {advocate.contact.address}
                  </a>
                </div>
              </div>
              <h3 className="text-2xl font-semibold mt-10 mb-4 text-white">Follow Us</h3>
      ...
      <footer className="bg-gray-950 text-white py-10 px-6 md:px-12 rounded-t-lg">
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6 mb-6">
            ...
            <a href="#gallery" className="text-gray-400 hover:text-white transition duration-300">Gallery</a>
